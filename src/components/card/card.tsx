...
export const Card = ({ title, description, imageUrl, price }: CardProps) => {
  return (
    ...
    <article className="flex flex-col gap-6 p-2 hover:shadow-sm hover:scale-[1.02] transition-transform border border-gray-300 rounded-xl max-w-sm">
         <Link href="HP">
